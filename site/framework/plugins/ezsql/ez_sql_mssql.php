<?php
	...
	*/
	...
	if ( ! function_exists ('mssql_connect') ) die('<b>Fatal Error:</b> ezSQL_mssql requires ntwdblib.dll to be present in your windows\system32 folder. Also enable MS-SQL extenstion in PHP.ini file ');
	...
	class ezSQL_mssql extends ezSQLcore
	{
		...
		*/
		...
		function ConvertMySqlToMSSql($query)
		{
			...
			$query = mb_eregi_replace($pattern, $replacement, $query);
